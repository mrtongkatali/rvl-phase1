...
class Delivery_Receipt {
	...
	function findAll($fields, $order = "", $limit = "", $condition) {
	...
	function findAllByDeliveryNo($params) {
	...
	function findAllClientDrPlansByDateRange($params) {
	...
	function findAllNotBilled($fields, $order = "", $limit = "") {
		$limit = ($limit == "" ? "" : " LIMIT {$limit}");
		$order = ($order == "" ? "" : " ORDER BY {$order}");
		$sql = " 
			SELECT " . field_injector($fields) . " FROM " . DELIVERY_RECEIPT . "
	...
	function searchByStatus($query, $status, $fields, $order = "", $limit = "") {
		$order = ($order == "" ? "" : " ORDER BY {$order}");
		$limit = ($limit == "" ? "" : " LIMIT {$limit}");
	...
	function countByStatus($query, $status) {
	...
	function findByDeliveryNo($delivery_no, $fields) {
		$sql = " 
			SELECT " . field_injector($fields) . " FROM " . DELIVERY_RECEIPT . "
	 ...
	 function findByDeliveryDetails($params) {
		$sql = " 
			SELECT " . field_injector($params['fields']) . " FROM " . DELIVERY_RECEIPT . "
			WHERE 
	...
	function scanDeliveryDetails($params) {
	...
	function findPrintedByDeliveryNo($params) {
		$sql = " 
			SELECT " . field_injector($params['fields']) . " FROM " . DELIVERY_RECEIPT . "
			WHERE 
				delivery_no 	= " . Mapper::safeSql($params['delivery_no']) . " AND
	...
	function countTotalClearedDrPlansByClient($params) {
	...
	function countTotalBilledDrPlansByClient($params) {
		$client_id = (int) $params['client_id'];
		$sql = " 
			SELECT COUNT(id) as total FROM " . DELIVERY_RECEIPT . "
			WHERE
	...
	function countTotalTripByDriver($params) {
		$sql = " 
			SELECT COUNT(id) as total FROM " . DELIVERY_RECEIPT . "
			WHERE
				(
	...
	function countWeeklyTripByDriver($params) {
	...
	function generateClearedPlansDatatable($params) {
