...
$drno = str_pad($receipt['delivery_no'], 12, "0", STR_PAD_LEFT);
$dataprepared = date("M d, Y H:i",strtotime($receipt['date_created']));

$driver1 = $receipt['driver_name'];
$driver2 = $receipt['other_driver_name'];
$plateno = strtoupper($receipt['plate_no']);
$dateofdelivery = date("M d, Y",strtotime($receipt['delivery_date']));

$clientname = $receipt['client_name'];
$deliveryaddress = $receipt['delivery_address'];
$pickupaddress = $receipt['pickup_point'];

$rvl_logo = base_url(). "/themes/images/rvllogoonly.gif";
...
<div style="width:100%; border: 2px solid #000; ">
  ...
  <table border="0">
  <tr>
    <td rowspan="3" width="100px"><p style="font-size: .5pt;"> </p><img src="'.$rvl_logo.'" /></td>
...
<table border="0">
  <tr>
    ...
    $itemTable = "<br /><br /><br /><br /><br /><br /><br /><br /><br /><br />";
  
    $itemTable .= '<table border="1">';
    $itemTable .= ' 
            <tr bgcolor="#353535" color="#fff" align="center" class="small medium">
              <td width="22%">VIN No.</td>
            <td width="8%">CS no.</td>
            <td width="16%">Model</td>
            <td width="18%">Color</td>
            <td width="4%">Qty.</td>
            <td width="6%">Setting</td>
            <td width="25.5%">Remarks</td>
            </tr>
  ';

    $row_counter = 0;
    foreach($vn_list as $key=>$value):
       $itemTable .= ' 
            <tr align="center" class="medium">
              <td>'.$value['vin_no'].'</td>
              <td>'.$value['conduction_sticker_no'].'</td>
              <td>'.$value['model'].'</td>
              <td>'.$value['color'].'</td>
              <td>'.$value['qty'].'</td>
      ...
      ';
    $total_unit += $value['qty'];
    $row_counter++;
    endforeach;
    

    for($i=0; $i<(8-$row_counter); $i++) {
      $itemTable .= ' 
            <tr align="center" class="medium">
              <td></td>
              <td></td>
    ...
    $itemTable .= '<table border="1"><tr class="medium">
              <td width="64%" align="right"> &nbsp;<span class="small medium">TOTAL UNIT    </span></td>
              <td width="4%" align="center"><b>' . $total_unit . '</b></td>
            </tr></table>';
...
<table border="0">
  ...
  <tr>
	...
	<td><p style="font-size: 5pt; "> </p></td>
    <td class="bdrbtm"><p style="font-size: 5pt; "> </p></td>
    <td><p style="font-size: 15pt; "> </p></td>
  </tr>
  <tr align="center">
    <td></td>
    <td ><p class="small">Name</p></td>
	<td></td>
	<td ><p class="small">Signature</p></td>
    <td></td>
    <td><p class="small">Name</p></td>
	<td></td>
    <td><p class="small">Signature</p></td>
  ...
  <tr align="center">
    <td></td>
    <td colspan="3"><p class="small">(Received in good order and condition)</p></td>
    <td></td>
	<td colspan="3"><p class="small">Approved By</p></td>
    <td></td>
  </tr>
</table>
...
$pdf->SetX(15);$pdf->SetFont('helvetica', 'R', 7);    $pdf->Cell(100, 0, 'PICK-UP ADDRESS', '', 1, 'L', 0, '', 0, false, 'T', 'C');$pdf->Ln(4);
$pdf->SetX(15);$pdf->SetFont('helvetica', 'R', 10);   $pdf->Cell(100, 0, $deliveryaddress, 'B', 1, 'L', 0, '', 0, false, 'T', 'C');
$pdf->SetX(15);$pdf->SetFont('helvetica', 'R', 7);    $pdf->Cell(100, 0, 'DELIVERY ADDRESS', '', 1, 'L', 0, '', 0, false, 'T', 'C');
